...
cookie = '__mta=209498669.1600777449132.1601110785065.1601114444345.22; uuid_n_v=v1; ' \
         'uuid=81860D10FCCE11EA8ECD3DB0936FC6C2155EA4AF29354BB0BC6C5DE7D6E449AE; ' \
         '_lxsdk_cuid=174b5c5601cc8-0deff943135f12-5313f6f-13c680-174b5c5601cc8; ' \
         '_lxsdk=81860D10FCCE11EA8ECD3DB0936FC6C2155EA4AF29354BB0BC6C5DE7D6E449AE; ' \
         'mojo-uuid=5b689612d14851df2d978834ba8363b4; ' \
         '_csrf=05b9b07c3a3938ff964737ad56d5bd6e975e49163080b8c4efd94be3dc069875; mojo-session-id={"id":"73109e1ca5bc4fb323a167c72c2de2a7","time":1601114444101}; mojo-trace-id=2; Hm_lvt_703e94591e87be68cc8da0da7cbd0be2=1600777445,1601022326,1601022812,1601114699; Hm_lpvt_703e94591e87be68cc8da0da7cbd0be2=1601114699; __mta=209498669.1600777449132.1601114444345.1601114699401.23; _lxsdk_s=174c9db9135-daa-0f0-264%7C%7C6'
...
def get_data(url):
    ...
    file_types = '，'.join(x.text.strip() for x in tag.ul.li.find_all('a'))
